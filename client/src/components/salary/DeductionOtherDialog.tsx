...
interface DeductionOtherDialogProps {
    open: boolean;
    onClose: () => void;
    record: any;
    initialData?: any[];
...
export function DeductionOtherDialog({ open, onClose, record, initialData, onConfirm }: DeductionOtherDialogProps) {
                    ...
                    <table className="w-full text-[13px] text-left">
                        <thead className="bg-[#eef3fb] rounded-t-lg">
                            <tr>
                                ...
                                <th className="px-3 py-3 font-semibold text-gray-900 text-right w-[140px]">Mức giảm trừ</th>
                                ...
                                <tr key={row.id} className="relative group hover:bg-gray-50/50 transition-colors">
                                    <td className="px-3 py-3 relative">
                                        ...
                                        <Input 
                                            ...
                                            placeholder="Nhập loại giảm trừ"
                                        />
                                    </td>
