...
interface BonusByDayDialogProps {
    open: boolean;
    onClose: () => void;
    record: any;
    initialData?: any[];
...
export function BonusByDayDialog({ open, onClose, record, initialData, onConfirm }: BonusByDayDialogProps) {
                    ...
                    <table className="w-full text-[13px] text-left">
                        <thead className="bg-[#eef3fb] rounded-t-lg">
                            <tr>
                                ...
                                <th className="px-3 py-3 font-semibold text-gray-900">Loại thưởng</th>
                                ...
                                <tr key={row.id} className="relative group hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td className="px-3 py-3">
                                        <Select value={row.type} onValueChange={(val) => updateRow(row.id, 'type', val)}>
                                            ...
                                            <SelectContent>
                                                <SelectItem value="excellent">Hoàn thành xuất sắc</SelectItem>
                                                <SelectItem value="overtime">Thưởng tăng ca</SelectItem>
                                            </SelectContent>
                                        </Select>
                                    </td>
                                    <td className="px-3 py-3">
